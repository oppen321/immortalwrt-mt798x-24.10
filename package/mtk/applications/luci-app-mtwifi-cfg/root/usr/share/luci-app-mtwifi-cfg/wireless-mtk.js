			...
			return network.getWifiNetwork(s.section).then(function(radioNet) {
				...
				if (hwtype == 'mac80211') {
					...
					if (!isDisabled) {
						...
						o = ss.taboption('advanced', form.Flag, 'mu_beamformer', _('MU-MIMO'), _('Enable MU-MIMO.'));
						...
						if (is_dbdc_main)
						{
							o = ss.taboption('advanced', form.Flag, 'whnat', _('Wireless HWNAT'), _('Enable Wireless HWNAT.'));
							o.default = o.enabled;
							 
							 o = ss.taboption('roaming', form.Flag, 'bandsteering', _('Band Steering'),_('Allows the AP to guide dual-band clients to the 5 GHz band.'));
							 o.default = o.disabled;
							 
							o = ss.taboption('advanced', form.Value, 'beacon_int', _('Beacon Interval'),_('The time interval between beacon transmissions.'));
							o.optional = true;
							o.datatype = 'range(20,999)';
							o.placeholder = 100;
						}

						o = ss.taboption('advanced', form.ListValue, 'twt', _('Target Wake Time'), _('Router will be in a sleep state during the rest of the time period else it receives a transmission command.'));
						add_dep_he_feature(o);
						o.value('', _('Disable'));
						o.value('1', _('Enable'));
						o.value('2', _('Force'));

						o = ss.taboption('advanced', form.Value, 'txpower', _('Maximum transmit power'), _('%'));
						o.datatype = 'range(1,100)';
						o.placeholder = 100;
					}

					o = ss.taboption('advanced', CBIWifiCountryValue, 'country', _('Country Code'), _('ISO/IEC 3166 alpha2 country code.'));
					o.wifiNetwork = radioNet;
				}
				...
				if (hwtype == 'mac80211') {
					...
					o = ss.taboption('macfilter', form.ListValue, 'macfilter', _('MAC Address Filter'), _('Allow or deny specific MAC addresses to associate with this network.'));
					o.depends('mode', 'ap');
					o.value('', _('disable'));
					o.value('allow', _('Allow listed only'));
					o.value('deny', _('Allow all except listed'));
					...
					o = ss.taboption('advanced', form.Flag, 'amsdu', _('A-MSDU'), _('Enable A-MSDU aggregation.'));
					o.depends('mode', 'ap');
					o.default = o.enabled;

					o = ss.taboption('advanced', form.Flag, 'uapsd', _('U-APSD'), _('Enable Unscheduled Automatic Power Save Delivery.'));
					o.depends('mode', 'ap');
					o.default = o.enabled;

					o = ss.taboption('advanced', form.Flag, 'autoba', _('Auto Block ACK'), _('Enable automatic Block ACK.'));
					o.depends('mode', 'ap');
					o.default = o.enabled;

					o = ss.taboption('advanced', form.Flag, 'mumimo_dl', _('MU-MIMO DL'), _('Enable MU-MIMO DL.'));
					o.depends('mode', 'ap');
					o.default = o.enabled;

					o = ss.taboption('advanced', form.Flag, 'mumimo_ul', _('MU-MIMO UL'), _('Enable MU-MIMO UL.'));
					o.depends('mode', 'ap');
					o.default = o.enabled;

					o = ss.taboption('advanced', form.Flag, 'ofdma_dl', _('OFDMA DL'), _('Enable OFDMA DL.'));
					o.depends('mode', 'ap');
					o.default = o.enabled;

					o = ss.taboption('advanced', form.Flag, 'ofdma_ul', _('OFDMA UL'), _('Enable OFDMA UL.'));
					o.depends('mode', 'ap');
					o.default = o.enabled;
					...
					o = ss.taboption('advanced', form.Value, 'frag', _('Fragmentation Threshold'), _('bytes'));
					o.datatype = 'min(256)';
					o.depends('mode', 'ap');
					o.placeholder = 2346;

					o = ss.taboption('advanced', form.Value, 'rts', _('RTS/CTS Threshold'), _('bytes'));
					o.datatype = 'uinteger';
					o.depends('mode', 'ap');
					o.placeholder = 2347;
				...
				encr = o = ss.taboption('encryption', form.ListValue, 'encryption', _('Encryption'), _('Select the encryption method used for this wireless network.'));
				o.depends('mode', 'ap');
				o.depends('mode', 'sta');
				o.depends('mode', 'adhoc');
				o.depends('mode', 'ahdemo');
				...
				if (hwtype == 'mac80211') {
					...
					o = ss.taboption('roaming', form.Value, 'kicklow', _('Kick low RSSI station threshold'), _('dBm'));
					o.optional    = true;
					o.placeholder = 0;
					o.datatype = 'range(-100,0)';
					o.depends('mode', 'ap');

					o = ss.taboption('roaming', form.Value, 'assocthres', _('Station associate threshold'), _('dBm'));
					o.optional    = true;
					o.placeholder = 0;
					o.datatype    = 'range(-100,0)';
					o.depends('mode', 'ap');

					o = ss.taboption('roaming', form.Value, 'steeringthresold', _('Roam steering threshold'), _('dBm'));
					o.optional    = true;
					o.placeholder = 0;
					o.datatype = 'range(-100,0)';
					o.depends('mode', 'ap');

					o = ss.taboption('roaming', form.DynamicList, 'steeringbssid',_('Roam target bssid'), _('MAC-List'));
					o.datatype = 'macaddr';
					o.optional    = true;
					o.placeholder = 0;
					o.depends('mode', 'ap');
